var calculateGrade = document.getElementById("calculate-grade"),
    ...
    gradeTable = document.getElementById("grade-table-body"),
...
addCourseBtn.addEventListener("click", function (e) {
    ...
    if (!grade || !credits) {
        alert("Enter both credit and grade");
        return;
    }
    ...
    tableRow.appendChild(removeIcon);
...
function calculateGradeFunc() {
    ...
    if ((creditWeight == 0 || creditsSum == 0) && !fail) {
